...
&nbsp;
<a href="https://linkedin.com/in/prakharpurwar"><img src="https://img.shields.io/badge/LinkedIn-Connect-0A66C2?style=flat-square&logo=linkedin&logoColor=white" /></a>
&nbsp;
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Data preprocessing & missing value treatment</li>
        <li>Feature selection & engineering</li>
        <li>Model training, tuning & evaluation</li>
      </ul>
      <p>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li>In-depth EDA on structured survey data</li>
        <li>Visual storytelling using Seaborn & Matplotlib</li>
        <li>Trend identification & actionable insight extraction</li>
      </ul>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white" />
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Diverse datasets — structured, messy, real-world</li>
        <li>Data cleaning, wrangling & pattern recognition</li>
        <li>Iterative improvement through continuous practice</li>
      </ul>
      <p>
...
<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=PrakharPurwar12&theme=tokyonight&hide_border=true" />
</div>
